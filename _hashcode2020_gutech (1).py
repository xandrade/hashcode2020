...
lib =  {'library_id': 1,
        'books_ids': l6,
        'number_books': l5[0],
        'sigup_process_days': l5[1],
        'maximum_allowed_shipment': l5[2],}
libraries.append(lib)
"""

print('number_books:', number_books)
print('number_libraries:', number_libraries)
print('maximum_days_scanning:', maximum_days_scanning)
print('books_scores:', books_scores)
libraries
...
def process_this():
  ...
  return library_id+1, result_library_summary, result_library_book_ids

for file_name in file_names:

  print(file_name)

  with open('/content/' + file_name + '.txt', 'r') as f:
    line = f.readline()
    l1 = line.replace('\n','').split(' ')
    l1 = list(map(int, l1))
    #print(l1)
    ...
    while True:
      ...
      with open('/content/' + file_name + '.out', 'w') as fo:
      ...
      for library_summary, library_book_ids in zip(result_library_summary, result_library_book_ids):
        #print(results)
        with open('/content/' + file_name + '.out', 'a') as fo:      
